...
const registerSchema = joi.object({
  ...
  roles: joi.array(),
  bussinessName: joi.string().optional(),
  // special_phone: joi.string().optional(),
  specialName: joi.string().optional(),
  mitham: joi.string().optional(),
  gush: joi.string().optional(),
  helka: joi.string().optional(),
});
...
router.post("/", async (req, res) => {
  try {
    ...
    if (!req.body.roles) req.body.roles = ["user"]; // default
