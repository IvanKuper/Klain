...
const Mycards: FunctionComponent<MycardsProps> = () => {
  ...
  const handleDelete = (card: Card) => {
    if (window.confirm(`${card.business_name} ימחק לצמיתות?`))
      deleteCard(card)
        .then(() => {
  ...
  return (
    <>
      ...
      <h1 className="text-center mt-5 mb-5">
        <i className="fa-regular fa-address-card"></i> כרטיס העסק שלי
      ...
      <div className="container-fluid _AllCards w-75 mb-5">
        <div className="row allCards">
          {card.length ? (
            ...
            <>
              <h4 className="text-center mt-5">אין לך כרטיס עסקי..</h4>
              <img
