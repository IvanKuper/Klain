      ...
      <div className="container-fluid">
        <div className="row">
          <div className="leftDiv col-lg-6">
            <img className="login" src="add.png" alt="" />
          </div>
          <div className="rightDivScreenFit col-lg-6">
            <h1 className="text-center">
              <i className="fa-regular fa-id-card"></i> הוספת פרטי איש מקצוע
            </h1>
            <p className="text-dark text-center mb-4">אנא מלא את כל הפרטים</p>
            {/* FORM */}
