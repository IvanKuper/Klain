...
interface HomeHebProps {}

const HomeHeb: FunctionComponent<HomeHebProps> = () => {
  return (
    <div>
      {/* <Navbar /> */}
      <section id="title">
        <div className="container-fluid content">
          ...
          <div className="row">
            <div className="col-lg-12 center">
              <img className="image img-fluid" src="logo.png" alt="" />
            </div>
            <div className="col-lg-12 center">
              <div className="buttons">
                <div className="row">
                  <Link
                    to={"/signin"}
                    className="col-lg-12 w-100 btn btn-dark my-3 homeBtn"
                  >
                    <i className="fa-solid fa-user"></i> אזור אישי דיירים
                  </Link>
                  <Link
                    to={"/entrepreneur"}
                    className="col-lg-12 w-100 btn btn-dark my-3 homeBtn"
                  >
                    <i className="fa-solid fa-user-pen"></i> אזור אישי יזמים
                  </Link>
                  <Link
                    to={"/professionals"}
                    className="col-lg-12 w-100 btn btn-dark my-3 homeBtn"
                  >
                    <i className="fa-solid fa-briefcase"></i> אזור אישי אנשי
                    מקצוע
                  </Link>
                </div>
              </div>
      ...
      {/* <img className="img-fluid" src="./building.png" alt="" /> */}
      <Footer />
    </div>
  );
};
